...
const merchantFeatureModules = [
  ...
  MerchantFeatureModule(
    ...
    options: [
      ...
      MerchantFeatureOption(
        key: 'catalogOrderQrCashier',
        titleKey: 'merchant.features.catalogOrderQrCashier',
        tooltipKey: 'merchant.features.catalogOrderQrCashierTip',
        icon: Icons.qr_code_rounded,
      ),
      MerchantFeatureOption(
        key: 'catalogOrderSendCashier',
        titleKey: 'merchant.features.catalogOrderSendCashier',
        tooltipKey: 'merchant.features.catalogOrderSendCashierTip',
        icon: Icons.outbox_rounded,
      ),
      MerchantFeatureOption(
        key: 'catalogTableOrders',
        titleKey: 'merchant.features.catalogTableOrders',
        tooltipKey: 'merchant.features.catalogTableOrdersTip',
