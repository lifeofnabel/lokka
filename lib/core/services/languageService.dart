...
class LanguageService {
  ...
  static const Map<String, String> _defaults = {
      // Stempelkarten (stamp cards) — German fallbacks so the UI never shows raw
      // keys even if the i18n JSON fails to load.
      'common.done': 'Fertig',
      ...
      'merchant.stamps.settingsStickTitle': 'Stempelstift',
      'merchant.stamps.settingsStickBody': 'Verbinde einen NFC-Stift mit einer Karte. Kunden tippen ihn an, um zu stempeln.',
      'merchant.stamps.settingsCapTitle': 'Kartenlimit',
      'merchant.stamps.settingsCapBody': 'Du kannst bis zu 3 Karten gleichzeitig aktiv haben.',
      'merchant.stamps.settingsRewardsTitle': 'Belohnungen',
      'merchant.stamps.settingsRewardsBody': 'Lege eine Hauptbelohnung fest und optional Zwischenstufen.',
      'merchant.stamps.templatesTitle': 'Mit Vorlage starten',
      'merchant.stamps.templatesSubtitle': 'Tippe eine Vorlage an und passe sie an.',
      'merchant.stamps.tiersTitle': 'Zwischenbelohnungen',
      'merchant.stamps.tiersSubtitle': 'Optional: Belohnungen vor der vollen Karte (z. B. 5 = Rabatt).',
      'merchant.stamps.tiersEmpty': 'Noch keine Zwischenbelohnungen.',
      'merchant.stamps.tiersAdd': 'Stufe hinzufügen',
      'merchant.stamps.tiersAtStamp': 'Bei Stempel',
      'merchant.stamps.tiersLabelHint': 'Belohnung (z. B. 10% Rabatt)',
      'merchant.stamps.previewCard': 'Karte',
      ...
      'merchant.stick.invalidQr': 'Das ist kein gültiger Stift-Code.',
      'merchant.stick.boundTo': 'Stift mit „{card}“ verbunden.',
      'merchant.stick.needCard': 'Erstelle und veröffentliche zuerst eine Karte.',
      'merchant.stick.pickCard': 'Mit welcher Karte verbinden?',
      'merchant.stick.alreadyBound': 'Bereits ein Stift verbunden',
      'merchant.stick.connected': 'NFC-Stift verbunden',
      'merchant.stick.notConnected': 'Kein Stift verbunden',
      'merchant.stampScan.title': 'Kunde stempeln',
      'merchant.stampScan.scanTitle': 'Kunden-QR scannen',
      'merchant.stampScan.scanHint': 'Scanne den Wallet-QR des Kunden',
      'merchant.stampScan.scanManual': 'Wallet-Code manuell eingeben',
      'merchant.stampScan.invalidQr': 'Kein gültiger Kunden-Code.',
      'merchant.stampScan.wrongMerchant': 'Dieser Code gehört zu einem anderen Geschäft.',
      'merchant.stampScan.rewardsLabel': 'VERDIENTE BELOHNUNGEN',
      'merchant.stampScan.cardsLabel': 'STEMPELKARTEN',
      'merchant.stampScan.noCards': 'Dieser Kunde hat noch keine deiner Karten.',
      'merchant.stampScan.stamped': '+{n} gestempelt',
      'merchant.stampScan.cardFull': 'Karte ist voll!',
      'merchant.stampScan.redeemTitle': 'Belohnung einlösen?',
      'merchant.stampScan.redeemBody': '„{reward}“ als verbraucht markieren?',
      'merchant.stampScan.redeemConfirm': 'Als verbraucht markieren',
      'merchant.stampScan.redeemed': 'Belohnung eingelöst',
      'merchant.stampScan.markUsed': 'Verbraucht',
      'merchant.stampScan.manyTitle': 'Wie viele Stempel?',
      'merchant.stampScan.chooseStamp': 'Kunde stempeln',
      'merchant.stampScan.chooseOrder': 'Bestellung scannen',
      'merchant.stampScan.err.cooldown': 'Bitte kurz warten, bevor du erneut stempelst.',
      'merchant.stampScan.err.card-full': 'Diese Karte ist bereits voll.',
      'merchant.stampScan.err.replay': 'Dieser Tipp wurde bereits gezählt.',
      'merchant.stampScan.err.invalid-tag': 'Ungültiger Stempel-Code.',
      'merchant.stampScan.err.login-required': 'Bitte melde dich an, um zu stempeln.',
      'merchant.stampScan.err.too-far': 'Du bist nicht in der Nähe des Geschäfts.',
      'merchant.stampScan.err.stick-unbound': 'Dieser Stift ist mit keiner Karte verbunden.',
      'merchant.stampScan.err.stick-unknown': 'Unbekannter Stift.',
      'merchant.stampScan.err.card-archived': 'Diese Karte ist archiviert.',
      'merchant.stampScan.err.card-inactive': 'Diese Karte ist pausiert.',
      'merchant.stampScan.err.not-completed': 'Die Karte ist noch nicht voll.',
      'merchant.stampScan.err.reward-not-found': 'Belohnung nicht gefunden.',
      'merchant.stampScan.err.not-your-reward': 'Diese Belohnung gehört nicht zu deinem Geschäft.',
      'merchant.stampScan.err.already-redeemed': 'Bereits eingelöst.',
      'merchant.stampScan.err.cannot-self-stamp': 'Du kannst dich nicht selbst stempeln.',
      'merchant.stampScan.err.invalid-stick': 'Ungültiger Stift-Code.',
      'merchant.stampScan.err.stick-owned-by-other': 'Dieser Stift gehört bereits einem anderen Geschäft.',
      ...
      'stampTap.completeTitle': 'Karte voll! 🎉',
      'stampTap.completeBody': 'Deine Belohnung wartet – tippe unten.',
      'stampTap.remaining': 'Noch {n} bis zur Belohnung',
      'stampTap.queuedTitle': 'Wird nachgetragen',
      'stampTap.queuedBody': 'Keine Verbindung – dein Stempel wird automatisch nachgetragen.',
      'stampTap.toWallet': 'Zur Wallet',
      'stampTap.errorTitle': 'Hat nicht geklappt',
      'app.name': 'Lokka',
      ...
      'merchant.stamps.customCountHint': 'Erlaubt sind 2 bis 30 Stempel.',
      'merchant.stamps.customCountClamped':
          'Wert auf den erlaubten Bereich (2-30) angepasst.',
      'merchant.stamps.charLimitHint':
          'Maximal 2 Zeichen werden auf dem Stempel angezeigt.',
      'merchant.stamps.stepIndicator': 'Schritt {current}/{total}',
      'merchant.stamps.previewLauncher': 'Vorschau ansehen',
      'merchant.stamps.previewLauncherHint':
      ...
      'merchant.stamps.deleteTitle': 'Karte löschen?',
      'merchant.stamps.deleteMessage':
          'Diese Stempelkarte wird dauerhaft entfernt. Kunden sehen sie dann nicht mehr.',
